           ...
           if(isset($_POST['addmonth'])){
            ...
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
              ...
              while(0 == 0){
                ...
                <tr>
                  <td> <span class = "form-control">所定労働日数</span></td>
                  <td> <span class = "form-control"> <?php echo $workingdateall ?></span></td>
                </tr>
                <tr>
                  <td> <span class = "form-control">時間外時間</span></td>
                  <td> <span class = "form-control"> <?php  echo caculateTime($Allovertime); ?></span></td>
                </tr>
                <tr>
                  <td> <span class = "form-control">休日時間</span></td>
                  <td> <span class = "form-control"> <?php  echo caculateTime($Allovertime2); ?></span></td>
                </tr>
                <tr>
